...
-- Creating table books ############### foreignkey incorrectly formed
CREATE TABLE books (
...
-- Creating table customers  ############### DEFAULT NULL SYNTAX ERROR
CREATE TABLE customers (
	...
	Country varchar(30) DEFAULT NULL,
	DOB date NOT NULL,
	Anniversary date DEFAULT NOT NULL,
...
-- Creating table transactiondetails  ############### foreignkey incorrectly formed
...
-- Creating table transactionmaster ############### foreignkey incorrectly formed
